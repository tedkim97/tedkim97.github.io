...
{% include caption_image.html imgpath="/figures/measuring_latency_simple_histogram.png" alt="small example of histogram of latencies" caption=caption1 %}
...
{% include caption_image.html imgpath="/figures/normal_distribution_with_pdf.png" alt="ideal histogram of latencies with probability density function" caption=caption2 %}
...
{% include caption_image.html imgpath="/figures/normal_distribution_with_outliers.png" alt="histogram of latencies with noise" caption=caption3 %}
...
{% include caption_image.html imgpath="/figures/normal_distribution_with_cutoff.png" alt="histogram of cleaned data with cutoff" caption=caption4 %}
...
{% include caption_image.html imgpath="/figures/normal_distribution_intersection.png" alt="histogram of cleaned data with cutoff" caption=caption5 %}
...
{% include caption_image.html imgpath="/figures/lognormal_latency.png" alt="simulation of more realistic latency distribution" caption=caption6 %}
...
{% include caption_image.html imgpath="/figures/logged_lognormal_latency.png" alt="Natural Log of Realistic Latency distribution" caption=caption7 %}
...
{% include caption_image.html imgpath="/figures/two_peaks_labeled.png" alt="histogram of different user locations" caption="Potential histogram of different user locations"%}
...
{% include caption_image.html imgpath="/figures/imbalanced_peaks.png" alt="histogram of different code versions" caption="Potential histogram of different code versions"%}
