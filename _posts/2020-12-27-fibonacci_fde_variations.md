...
<!-- {% include caption_image.html imgpath="/figures/fib_naive_vis.svg" alt="fig1" caption="hi" %} -->
...
<!-- {% include caption_image.html imgpath="/figures/fib_fd_vis.svg" alt="fig2" caption="hi" %} -->
