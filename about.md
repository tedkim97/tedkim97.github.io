...
I try to not upload content that already exists on the internet (these 5 numpy tips will blow your mind!! How to do a linear regression!!) unless I can (try) to add value to it. I try to upload posts for completeness and correctness - meaning that their might be a lot of redundant bits for an expert.  
